...
## 注意事項
・トラックボールのFPCケーブルを調整またはトラックボールを交換する際は、必ず右手の電源をオフにしてください。電源が入ったままFPCケーブルを抜くと、キーボードが破損する恐れがありますのでご注意ください。この場合、トラックボールを装着しても反応しないため、電源の再起動またはリセットボタンの押下が必要となります。⚠︎FPCケーブルを強い力で引っ張らないでください。
